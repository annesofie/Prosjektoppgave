...
\section{FKB building type to OSM building value}
\begin{table}[H]
\begin{tabular}{ | l | l | l | }
\hline
...
\end{tabular}
\caption{Translating FKB buildingtypes to OpenStreetMap values, part 1}
...
\end{tabular}
\caption{Translating FKB buildingtypes to OpenStreetMap values, part 2}
\label{tab:fkbtoosmdel2}
\end{table}

\section{Code snip from .lua file, setting building=* value}
\lstset{
    language={[5.0]Lua},
