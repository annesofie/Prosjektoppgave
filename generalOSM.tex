...
%This chapter study how this huge project manage to organize itself. 

Important information when looking at how to import new data into OpenStreetMap is understanding the data structure of OpenStreetMap. This data structure is unique and only supported by OSM. This chapter will give an introduction to this structure. It will also cover how this data structure is realized *%Riktig bruk av ordet?
